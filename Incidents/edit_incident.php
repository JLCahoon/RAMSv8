                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    ...
                                                    <label>Owner</label>
                                                    <input type="text" name="Owner" class="form-control" width="500px" value="<?php echo $row['Owner']; ?>"/>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <input type="text" name="Priority" id="PIValue" class="form-control" value="<?php echo $row['Priority']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <label>Risk ID</label>
                                                    <input type="text" name="RiskID" id="RiskID" class="form-control" value="<?php echo $row['RiskID']; ?>"/>

                                                    <label>Risk Name</label>
                                                    <input type="text" name="RiskName" class="form-control" value="<?php echo $row['RiskName']; ?>">
                                                </div>
                                            </div>
                                        </div>
