...
if (count($_POST) > 0) {
    ...
    $sql = "INSERT INTO Incidents (IncidentName, IncidentDate, Owner, ReportedBy, Location, Description, Systems, Type, Impact, Department, Priority, RiskName) VALUES ('" . $_POST["IncidentName"] . "','" . $_POST["IncidentDate"] . "','" . $_POST["Owner"] . "','" . $_POST["ReportedBy"] . "','" . $_POST["Location"] . "','" . $_POST["Description"] . "','" . $_POST["Systems"] . "','" . $_POST["Type"] . "','" . $_POST["Impact"] . "','" . $_POST["Department"] . "','" . $_POST["Priority"] . "','" . $_POST["RiskName"] . "')";
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <i class="fa fa-database"></i> <a href="index.php">Incidents</a>
                                </li>
                                <li class="active">
    ...
    echo $message;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <input type="text" name="IncidentName" class="form-control" width="500px" />
                                    
                                    <label>Incident Date</label>
                                    <input type="text" name="IncidentDate" class="form-control" width="500px"/>

                                    <label>Owner</label>
                                    <input type="text" name="Owner" class="form-control" width="500px">
                                    
                                    <label>Reported By</label>
                                    <input type="text" name="ReportedBy" class="form-control" width="500px" />
                                    
                                    <label>Location</label>
                                    <input type="text" name="Location" class="form-control" width="500px" />
                                    
                                    <label>Description</label>
                                    <input type="text" name="Description" class="form-control" width="500px" />
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse">
                <div class="panel-body">
                    <label>Systems</label>
                                    <input type="text" name="Systems" class="form-control" />
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseThree" class="panel-collapse collapse">
                <div class="panel-body">
                                    ...
                                    <label>Risk ID</label>
                                    <input type="text" name="RiskID" id="RiskID" class="form-control" />
