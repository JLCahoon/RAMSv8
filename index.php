  ...
  <tr height="50px">
    ...
    <td width="100px" align="center">Catastrophic</td>
            ...
            <?php
                            ...
                            $sql = "SELECT * FROM RiskRegister2 WHERE Owner=".$_SESSION['userSession'];
                            $result = $conn->query($sql);
